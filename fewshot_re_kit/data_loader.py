...
def get_loader(name, encoder, N, K, Q, batch_size, 
               num_workers=0, collate_fn=collate_fn, ispubmed=False, root='../data'):
...
def get_loader_unsupervised(name, encoder, N, K, Q, batch_size, 
                            num_workers=0, collate_fn=collate_fn_unsupervised, root='../data'):
...
def get_loader_test(name, encoder, N, K, Q, batch_size,
                    num_workers=0, collate_fn=collate_fn_test, ispubmed=False, root='../data'):
